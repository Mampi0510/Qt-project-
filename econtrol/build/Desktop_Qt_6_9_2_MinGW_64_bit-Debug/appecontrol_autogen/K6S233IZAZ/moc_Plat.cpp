...
template <> constexpr inline auto Plat::qt_create_metaobjectdata<qt_meta_tag_ZN4PlatE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'idPlatChanged'
        QtMocHelpers::SignalData<void()>(1, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'nomPlatChanged'
        QtMocHelpers::SignalData<void()>(3, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'prixChanged'
        QtMocHelpers::SignalData<void()>(4, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'categorieChanged'
    ...
    QtMocHelpers::UintData qt_properties {
        ...
        // property 'prix'
        QtMocHelpers::PropertyData<double>(11, QMetaType::Double, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 2),
        // property 'categorie'
...
void Plat::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->idPlatChanged(); break;
        case 1: _t->nomPlatChanged(); break;
        case 2: _t->prixChanged(); break;
        case 3: _t->categorieChanged(); break;
        case 4: _t->ajouterPlat(); break;
        case 5: _t->modifierPlat(); break;
        case 6: _t->supprimerPlat(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Plat::*)()>(_a, &Plat::idPlatChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Plat::*)()>(_a, &Plat::nomPlatChanged, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Plat::*)()>(_a, &Plat::prixChanged, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (Plat::*)()>(_a, &Plat::categorieChanged, 3))
            return;
    }
    if (_c == QMetaObject::ReadProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast<int*>(_v) = _t->getIdPlat(); break;
        case 1: *reinterpret_cast<QString*>(_v) = _t->getNomPlat(); break;
        case 2: *reinterpret_cast<double*>(_v) = _t->getPrix(); break;
        case 3: *reinterpret_cast<QString*>(_v) = _t->getCategorie(); break;
        default: break;
        }
    }
    if (_c == QMetaObject::WriteProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setIdPlat(*reinterpret_cast<int*>(_v)); break;
        case 1: _t->setNomPlat(*reinterpret_cast<QString*>(_v)); break;
        case 2: _t->setPrix(*reinterpret_cast<double*>(_v)); break;
        case 3: _t->setCategorie(*reinterpret_cast<QString*>(_v)); break;
        default: break;
        }
    }
}
...
// SIGNAL 0
void Plat::idPlatChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Plat::nomPlatChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void Plat::prixChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void Plat::categorieChanged()
{
